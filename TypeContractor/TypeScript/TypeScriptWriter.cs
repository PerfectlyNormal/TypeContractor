...
public class TypeScriptWriter(string outputPath)
{
	...
	public string Write(OutputType outputType, IEnumerable<OutputType> allTypes, bool buildZodSchema)
	{
		...
		BuildHeader(Contractor.Version);
	...
	private void BuildHeader(string version)
	{
		_builder.AppendLine("/*");
		_builder.AppendLine($" * This source code was auto-generated by TypeContractor, Version {version}");
